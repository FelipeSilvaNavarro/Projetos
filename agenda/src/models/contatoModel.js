...
Contato.prototype.valida = function () {
    ...
    if (!this.body.email && !this.body.telefone) this.errors.push('Email ou telefone precisa ser enviado')
...
Contato.prototype.edit = async function (id) {
    ...
    this.contato= await contatoModel.findByIdAndUpdate(id, this.body, { new: true }) // Quando atualizar o contato, retorna os dados att, e nn os old
}
