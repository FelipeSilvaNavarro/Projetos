...
class Login {
    ...
    async register () { // É async pq sempre que trabalha com bd, se trabalha com promise pois retorna promise
        this.valida()
    ...
    valida () {
        ...
        if (!validator.isEmail(this.body.email)) this.errors.push('E-mail inválido')// Se nn for um email valido, lança um erro no array
